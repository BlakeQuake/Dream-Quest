...
if (charInfo.boardMovement > 0) {
    $("#charCol").attr("style", "display: none;")
...
function startGame() {
    $(".currentSpace").each(function (index) {
        ...
        if ($(this).data("space") == 0) {
            $(this).html(`<img src="/images/${charInfo.chosenCharacter}.png" alt="choosen character" height="100px" width="100px" class="yo"> `)
            $(".begin").hide()
            $(".begin").fadeIn(4000)
        }
    })
